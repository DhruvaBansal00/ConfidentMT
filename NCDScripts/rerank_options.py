...
def add_reranking_args(parser):
    ...
    group.add_argument('--max-tokens', type=int, metavar='N', default=4000,
                       help='max-tokens for generating the nbest list')
    ...
    group.add_argument('--bitext-remove-bpe', default='sentencepiece',
                       help='the bpe symbol, used for the bitext')
    group.add_argument('--lm-remove-bpe', default='@@ ',
                       help='the bpe symbol, used for the LM')
    group.add_argument('--sacrebleu', action='store_true',
                       help='use sacrebleu as scorer')
